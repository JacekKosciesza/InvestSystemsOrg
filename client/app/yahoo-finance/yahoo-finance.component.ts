...
@Component({
    ...
    providers: [YahooFinanceService, MACDService],
    directives: [StockPricesChartComponent, MacdSignalChartComponent]
})
export class YahooFinanceComponent implements OnInit {
    ...
    macd: any;
    constructor(private yfs: YahooFinanceService, private macdService: MACDService) {
