...
import { App, MenuController, NavController, Platform, Config, Keyboard, Form, IonicModule, NavParams, ModalController }  from 'ionic-angular';
import { ConfigMock, NavMock, PlatformMock, NavParamsMock, ModalControllerMock, IdentityServiceMock, CompanyServiceMock, ToastServiceMock } from './mocks';
